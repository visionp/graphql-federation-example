...
У кожної книги є автор, GraphQL-сервер спочатку зробить один запит для отримання 
всіх книг, а потім для кожної книги зробить окремий запит для отримання її автора. 
